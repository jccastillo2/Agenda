...
import demo.demo.Security.filter.JwtFilterRequest
import demo.demo.service.AppUserDetailsService
...
class SeurityConfiguration : WebSecurityConfigurerAdapter() {
    @Autowired
